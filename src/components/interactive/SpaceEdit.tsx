...
export default function SpaceEdit({ spaceId }: SpaceEditProps) {
  ...
  const handleSaveSpace = async (spaceId: number) => {
    ...
    try {
      ...
      const result = await updateSpace(spaceId, editingSpaceName, editingSpaceDescription, EXTERNAL.directus_url);
  ...
  const handleCreateSpace = async () => {
    ...
    try {
      // Create the space
      const spaceResult = await createSpace(newSpaceName, newSpaceDescription, EXTERNAL.directus_url);
